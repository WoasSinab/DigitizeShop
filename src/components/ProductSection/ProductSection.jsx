...
// Color URLs for different product colors
const colorImages = {
      ...
      <div className='flex items-center justify-between w-full mb-3'>
        ...
        <div className='flex items-center'>
          ...
          {["red", "blue", "green"].map((color) => (
            <div key={color} className={`h-6 w-6 -mr-1 rounded-full flex items-center justify-center cursor-pointer bg-${color}-400 border-2 ${selectedColor === color ? "border-white" : `border-${color}-400`} ${color !== "green" && "-mr-1"}`} onClick={() => handleColorClick(color)}>
